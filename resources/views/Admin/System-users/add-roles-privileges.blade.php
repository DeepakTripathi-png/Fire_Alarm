                                            ...
                                            <tbody id="role-privileges-table">
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                    <td class="text-center">2</td>
                                                    <td>Admin</td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="admin_view" class="ccheckbox view" value="admin_view" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'admin_view') ? 'checked' : '' }}></td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="admin_view" class="ccheckbox view" value="admin_view" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'admin_view') ? 'checked' : '' }}></td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="admin_view" class="ccheckbox view" value="admin_view" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'admin_view') ? 'checked' : '' }}></td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="admin_view" class="ccheckbox view" value="admin_view" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'admin_view') ? 'checked' : '' }}></td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="admin_view" class="ccheckbox view" value="admin_view" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'admin_view') ? 'checked' : '' }}></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="master_add" class="ccheckbox view" value="master_add" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'master_view') ? 'checked' : '' }}></td>
                                                   <td class="text-center"><input type="checkbox" name="privileges[]" id="master_edit" class="ccheckbox view" value="master_edit" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'master_view') ? 'checked' : '' }}></td>
                                                   <td class="text-center"><input type="checkbox" name="privileges[]" id="master_delete" class="ccheckbox view" value="master_delete" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'master_view') ? 'checked' : '' }}></td>
                                                   <td class="text-center"><input type="checkbox" name="privileges[]" id="master_status" class="ccheckbox view" value="master_status" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'master_view') ? 'checked' : '' }}></td>
                                                    <td class="text-center"></td>
                                                </tr>
                                                <!-- Site Master -->
                                                <tr>
                                                    ...
                                                    <td> customer</td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="customer_view" class="ccheckbox view" value="customer_view" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'customer_view') ? 'checked' : '' }}></td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="customer_add" class="ccheckbox add" value="customer_add" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'customer_add') ? 'checked' : '' }}></td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="customer_edit" class="ccheckbox edit" value="customer_edit" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'customer_edit') ? 'checked' : '' }}></td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="customer_delete" class="ccheckbox deletes" value="customer_delete" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'customer_delete') ? 'checked' : '' }}></td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="customer_status" class="ccheckbox status" value="customer_status" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'customer_status') ? 'checked' : '' }}></td>
                                                ...
                                                <tr>
                                                    <td class="text-center">2</td>
                                                    <td>Location</td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="location_view" class="ccheckbox view" value="location_view" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'location_view') ? 'checked' : '' }}></td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="location_add" class="ccheckbox add" value="location_add" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'location_add') ? 'checked' : '' }}></td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="location_edit" class="ccheckbox edit" value="location_edit" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'location_edit') ? 'checked' : '' }}></td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="location_delete" class="ccheckbox delete" value="location_delete" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'location_delete') ? 'checked' : '' }}></td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="location_status" class="ccheckbox status" value="location_status" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'location_status') ? 'checked' : '' }}></td>
                                                ...
                                                <tr>
                                                    <td class="text-center">2</td>
                                                    <td>Alarm</td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="alarm_view" class="ccheckbox view" value="alarm_view" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'alarm_view') ? 'checked' : '' }}></td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="alarm_edit" class="ccheckbox edit" value="alarm_edit" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'alarm_edit') ? 'checked' : '' }}></td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="alarm_add" class="ccheckbox add" value="alarm_add" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'alarm_add') ? 'checked' : '' }}></td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="alarm_delete" class="ccheckbox delete" value="alarm_delete" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'alarm_delete') ? 'checked' : '' }}></td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="alarm_status" class="ccheckbox status" value="alarm_status" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'alarm_status') ? 'checked' : '' }}></td>
                                                    {{-- <td class="text-center"><input type="checkbox" name="privileges[]" id="alarm_view" class="ccheckbox view" value="alarm_view" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'alarm_view') ? 'checked' : '' }}></td> --}}
                                                    {{-- <td class="text-center"></td> --}}   
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="reports_edit" class="ccheckbox edit" value="reports_edit" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'reports_edit') ? 'checked' : '' }}></td>
                                                    {{-- <td class="text-center"><input type="checkbox" name="privileges[]" id="reports_view" class="ccheckbox add" value="reports_add" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'reports_add') ? 'checked' : '' }}></td> --}}
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="reports_add" class="ccheckbox view" value="reports_view" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'reports_view') ? 'checked' : '' }}></td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="reports_delete" class="ccheckbox delete" value="reports_delete" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'reports_delete') ? 'checked' : '' }}></td>
                                                    <td class="text-center"><input type="checkbox" name="privileges[]" id="reports_status" class="ccheckbox status" value="reports_status" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges,'reports_status') ? 'checked' : '' }}></td>
                                                    {{-- <td class="text-center"></td> --}}   
                                                </tr>
